...
//div[@id='i2008889556']/descendant::span[text()=’item-price’]
  ...
  System.out.println("Самый дорогой принтер: " + driver.findElement(By.xpath("//a[@title='3D принтер в Владивостоке']/span")).getText());
  System.out.println("Цена: " + driver.findElement(By.xpath("//span[@data-marker='item-price']")).getText());
